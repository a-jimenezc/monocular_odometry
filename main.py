...
K = np.array([
        [608.56811625, 0, 629.83269351],
        [0, 614.54502235, 346.79688358],
        [0, 0, 1]
    ], dtype=np.float32)
K = np.array([
    [288.44, 0, 322.12],  
...
init_keyframe_poses, keyframes, optimized_points_3d, video_handler = initialize(video_path, K, max_nfev=10)
